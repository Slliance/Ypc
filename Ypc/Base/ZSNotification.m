...
+(void)addChangeDirectionResultNotification:(id)target action:(SEL)action{
    [[NSNotificationCenter defaultCenter] addObserver:target
                                             selector:action
                                                 name:changeDirectionNotification
                                               object:nil];
}
+(void)postChangeDirectionResultNotification:(NSDictionary *)userInfo{
     [[NSNotificationCenter defaultCenter] postNotificationName:changeDirectionNotification object:nil userInfo:userInfo];
}
@end
