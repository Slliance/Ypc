...
- (void)showLoading {
    ...
    if ([viewController isKindOfClass:[BaseTabBarController class]]) {
        BaseTabBarController *tabbar = (BaseTabBarController *)viewController;
...
- (void)hiddenLoading {
    ...
    if ([controller isKindOfClass:[BaseTabBarController class]]) {
        BaseTabBarController *tabbar = (BaseTabBarController *)controller;
        if ([tabbar.selectedViewController isKindOfClass:[UINavigationController class]]) {
            UINavigationController *nav = (UINavigationController *)tabbar.selectedViewController;
            [self.arrayLodingControllers addObjectsFromArray:nav.viewControllers];
            dispatch_async(dispatch_get_main_queue(), ^{
